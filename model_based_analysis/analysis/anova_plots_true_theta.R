...
p_model_true_theta_accuracy_score_truerule %>%
  save_svg_figure(paste0("p_model_true_theta_accuracy_score_truerule"),
    analysis_group = fs::path("model_true_theta"),
...
p_model_true_theta_entropy_score_truerule %>%
  save_svg_figure(paste0("p_model_true_theta_entropy_score_truerule"),
    analysis_group = fs::path("model_true_theta"),
    scaling = fig_anova_scale, width = fig_anova_width, height = fig_anova_height, unit = "mm"
  )
...
p_model_true_theta_conf_switch %>%
  save_svg_figure("p_model_true_theta_conf_switch",
    analysis_group = fs::path("model_true_theta"),
...
df_wilcox_param_gamma_true_theta <- df_MLE_result_binary %>%
  ...
  filter(params == "gamma") %>%
  rstatix::wilcox_test(value ~ 1, mu = 0, exact = TRUE)
...
p_param_all_true_theta %>% save_svg_figure("p_param_all_true_theta",
  analysis_group = "model_true_theta",
  scaling = fig_anova_scale,
...
p_weights_true_theta %>% save_svg_figure("p_weights_true_theta",
  analysis_group = "model_true_theta",
  scaling = fig_anova_scale,
...
p_biases_true_theta %>% save_svg_figure("p_biases_true_theta",
  analysis_group = "model_true_theta",
  scaling = fig_anova_scale,
  width = fig_2box_width,
  height = fig_2box_height,
...
p_forgetting_factor_true_theta %>% save_svg_figure("p_forgetting_factor_true_theta",
  analysis_group = "model_true_theta",
  scaling = fig_anova_scale,
